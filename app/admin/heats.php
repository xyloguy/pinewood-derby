        ...
        <div class="col-md-6 mb-md-5">
            ...
            <form action="heats.php" method="post">
                ...
                <div class="form-group">
                    ...
                    echo '<button class="btn btn-secondary" type="button" data-group="all">Select All</button>';
                    $largest_group = 4;
                    foreach ($groups as $group) {
                        $racers = $group->racers();
                        if (count($racers) == 0) { continue; }
                        if (count($racers) > $largest_group) {
                            $largest_group = count($racers);
                        }
                        echo '<button class="btn btn-secondary" type="button" autocomplete="off" data-group="'.$group->name().'">'.$group->name().'</button>';
                    }
                    echo '</div>';
                    ?>
                    <div class="form-group">
                ...
                <button type="submit" name="generateheats" class="btn btn-primary"><i class="bi-plus-lg"></i> Generate Heats</button>
            </form>
        </div>
